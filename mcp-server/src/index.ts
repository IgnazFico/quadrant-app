...
server.tool(
  "seed_test_scenario",
  "Seeds a test user configured for specific testing scenarios (e.g. mission statement gate, unreviewed goals)",
  {
...
server.tool(
  ...
  "Executes Playwright end-to-end test suites and returns formatted results",
  {
